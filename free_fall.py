...
#plt.yscale("Linear")
#plt.xscale("Linear")
plt.plot(tdata, pdata,label='Free Fall', color = 'm', marker = '.', linestyle = '')
plt.show()
...
plt.plot(tdata, a, color = 'r', linestyle = '-', label = 'Ajuste a una constante $y$')
plt.legend()
plt.show()
